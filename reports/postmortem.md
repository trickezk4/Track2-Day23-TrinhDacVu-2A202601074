...
3. Nếu outage kéo dài 6 giờ và region chính mất dữ liệu vĩnh viễn, con số docs_lost = 2 đồng nghĩa với việc chỉ có 2 documents phát sinh trong khoảng 4 giây trước sự cố chưa kịp replicate là bị mất, còn lại toàn bộ cơ sở dữ liệu vector index đã được bảo toàn và phục hồi đầy đủ sang region phụ.
